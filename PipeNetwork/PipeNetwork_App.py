...
class MainWindow(qtw.QWidget, Ui_Form):
    def __init__(self):
        ...
        self.Controller.setWidgets((self.tree_Pipes,self.tree_Nodes, self.tree_Loops, self.lbl_FlowRates, self.lbl_NodePressures, self.lbl_PipeHeadLosses, self.lbl_PressureAndFlowChecks))
    ...
    def readPipeNetworkFile(self):
        ...
        self.Controller.importPipeNetwork(data)  # import the pipe network information
